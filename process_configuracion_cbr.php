...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO bc_cbr (bc_cbr_vacuna, bc_cbr_dosis, bc_cbr_costo, bc_cbr_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE bc_cbr 
                    SET bc_cbr_vacuna = :vacuna, 
                        bc_cbr_dosis = :dosis, 
                        bc_cbr_costo = :costo, 
                        bc_cbr_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM bc_cbr WHERE id = :id";
