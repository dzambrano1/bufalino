...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO bc_parasitos (bc_parasitos_vacuna, bc_parasitos_dosis, bc_parasitos_costo, bc_parasitos_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE bc_parasitos 
                    SET bc_parasitos_vacuna = :vacuna, 
                        bc_parasitos_dosis = :dosis, 
                        bc_parasitos_costo = :costo, 
                        bc_parasitos_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM bc_parasitos WHERE id = :id";
