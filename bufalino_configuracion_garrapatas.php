...
<title>Bufalino Configuracion Garrapatas</title>
<!-- Link to the Favicon -->
        ...
        <div class="col-12 col-md-6 col-lg-4">
            <div class="d-flex justify-content-center">
                <div class="arrow-step arrow-step-active w-100" style="border-radius: 15px; clip-path: none;">
                    <span class="badge-active">🎯 Estás configurando Garrapatas</span>
...
<div class="container table-section" style="display: block;">
      <div class="table-responsive">
          <table id="garrapatasTable" class="table table-striped table-bordered">
              ...
              <tbody>
                  <?php
                      $garrapatasQuery = "SELECT * FROM bc_garrapatas";
                      ...
                      if (empty($garrapatassData)) {
                          ...
                          foreach ($garrapatassData as $row) {
                              ...
                              echo '        <button class="btn btn-warning btn-sm edit-garrapatas" 
                                              ...
                                              data-vacuna="' . htmlspecialchars($row['bc_garrapatas_vacuna'] ?? '') . '" 
                                              data-dosis="' . htmlspecialchars($row['bc_garrapatas_dosis'] ?? '') . '" 
                                              data-costo="' . htmlspecialchars($row['bc_garrapatas_costo'] ?? '') . '" 
                                              data-vigencia="' . htmlspecialchars($row['bc_garrapatas_vigencia'] ?? '') . '"
                              ...
                              // Column 1: Vacuna
                              echo "<td>" . htmlspecialchars($row['bc_garrapatas_vacuna'] ?? '') . "</td>";
                              
                              // Column 2: Dosis
                              echo "<td>" . htmlspecialchars($row['bc_garrapatas_dosis'] ?? 'N/A') . "</td>";
                              
                              // Column 3: Costo
                              echo "<td>" . htmlspecialchars($row['bc_garrapatas_costo'] ?? 'N/A') . "</td>";
                              
                              // Column 4: Vigencia
                              echo "<td>" . htmlspecialchars($row['bc_garrapatas_vigencia'] ?? 'N/A') . "</td>";
