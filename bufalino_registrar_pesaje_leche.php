...
<div class="container scroll-icons-container">
    <button class="btn btn-outline-secondary mb-3" type="button" onclick="window.location.href='./bufalino_registrar_pesaje_animal.php'" data-tooltip="Pesaje Carne">
    ...
    <button class="btn btn-outline-secondary mb-3" type="button" onclick="window.location.href='./bufalino_registrar_alimentacion.php'" data-tooltip="Alimentacion">
    ...
    <button class="btn btn-outline-secondary mb-3" type="button" onclick="window.location.href='./bufalino_registrar_reproduccion.php'" data-tooltip="Reproducion">
        <img src="./images/el-embarazo.png" alt="Reproduccion" class="nav-icon">
    </button>

    <button class="btn btn-outline-secondary mb-3" type="button" data-bs-toggle="collapse" onclick="window.location.href='./bufalino_registrar_poblacion.php'" data-tooltip="Poblacion">
...
<?php
    ...
    $lecheQuery = "SELECT p.*, 
                  ...
                  FROM vh_leche p 
                  LEFT JOIN bufalino v ON p.vh_leche_tagid = v.tagid 
                ...
                .then(data => {
                    if (data.success) {
                        Swal.fire({
                            ...
                            window.location.href = data.redirect || 'bufalino_registrar_leche.php';
                        });
                    } else {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        Swal.fire({
                            ...
                            window.location.href = data.redirect || 'bufalino_historial.php';
                        });
                    } else {
