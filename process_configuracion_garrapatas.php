...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO bc_garrapatas (bc_garrapatas_vacuna, bc_garrapatas_dosis, bc_garrapatas_costo, bc_garrapatas_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE bc_garrapatas 
                    SET bc_garrapatas_vacuna = :vacuna, 
                        bc_garrapatas_dosis = :dosis, 
                        bc_garrapatas_costo = :costo, 
                        bc_garrapatas_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM bc_garrapatas WHERE id = :id";
