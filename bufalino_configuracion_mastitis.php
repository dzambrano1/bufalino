...
<title>Bufalino Configuracion Mastitis</title>
<!-- Link to the Favicon -->
...
<div class="container table-section" style="display: block;">
      <div class="table-responsive">
          <table id="mastitisTable" class="table table-striped table-bordered">
              ...
              <tbody>
                  <?php
                      $mastitisQuery = "SELECT * FROM bc_mastitis";
                      ...
                      if (empty($mastitissData)) {
                          ...
                          foreach ($mastitissData as $row) {
                              ...
                              echo '        <button class="btn btn-warning btn-sm edit-mastitis" 
                                              ...
                                              data-vacuna="' . htmlspecialchars($row['bc_mastitis_vacuna'] ?? '') . '" 
                                              data-dosis="' . htmlspecialchars($row['bc_mastitis_dosis'] ?? '') . '" 
                                              data-costo="' . htmlspecialchars($row['bc_mastitis_costo'] ?? '') . '" 
                                              data-vigencia="' . htmlspecialchars($row['bc_mastitis_vigencia'] ?? '') . '"
                              ...
                              // Column 1: Vacuna
                              echo "<td>" . htmlspecialchars($row['bc_mastitis_vacuna'] ?? '') . "</td>";
                              
                              // Column 2: Dosis
                              echo "<td>" . htmlspecialchars($row['bc_mastitis_dosis'] ?? 'N/A') . "</td>";
                              
                              // Column 3: Costo
                              echo "<td>" . htmlspecialchars($row['bc_mastitis_costo'] ?? 'N/A') . "</td>";
                              
                              // Column 4: Vigencia
                              echo "<td>" . htmlspecialchars($row['bc_mastitis_vigencia'] ?? 'N/A') . "</td>";
