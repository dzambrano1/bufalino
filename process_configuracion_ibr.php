...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO bc_ibr (bc_ibr_vacuna, bc_ibr_dosis, bc_ibr_costo, bc_ibr_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE bc_ibr 
                    SET bc_ibr_vacuna = :vacuna, 
                        bc_ibr_dosis = :dosis, 
                        bc_ibr_costo = :costo, 
                        bc_ibr_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM bc_ibr WHERE id = :id";
