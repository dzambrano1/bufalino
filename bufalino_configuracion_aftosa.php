...
<title>Bufalino Configuracion Aftosa</title>
<!-- Link to the Favicon -->
...
<div class="container table-section" style="display: block;">
      <div class="table-responsive">
          <table id="aftosaTable" class="table table-striped table-bordered">
              ...
              <tbody>
                  <?php
                      $aftosaQuery = "SELECT * FROM bc_aftosa";
                      ...
                      if (empty($aftosasData)) {
                          ...
                          foreach ($aftosasData as $row) {
                              ...
                              echo '        <button class="btn btn-warning btn-sm edit-aftosa" 
                                              ...
                                              data-vacuna="' . htmlspecialchars($row['bc_aftosa_vacuna'] ?? '') . '" 
                                              data-dosis="' . htmlspecialchars($row['bc_aftosa_dosis'] ?? '') . '" 
                                              data-costo="' . htmlspecialchars($row['bc_aftosa_costo'] ?? '') . '" 
                                              data-vigencia="' . htmlspecialchars($row['bc_aftosa_vigencia'] ?? '') . '"
                              ...
                              // Column 1: Vacuna
                              echo "<td>" . htmlspecialchars($row['bc_aftosa_vacuna'] ?? '') . "</td>";
                              
                              // Column 2: Dosis
                              echo "<td>" . htmlspecialchars($row['bc_aftosa_dosis'] ?? 'N/A') . "</td>";
                              
                              // Column 3: Costo
                              echo "<td>" . htmlspecialchars($row['bc_aftosa_costo'] ?? 'N/A') . "</td>";
                              
                              // Column 4: Vigencia
                              echo "<td>" . htmlspecialchars($row['bc_aftosa_vigencia'] ?? 'N/A') . "</td>";
