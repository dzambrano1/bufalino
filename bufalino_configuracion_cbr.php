...
<title>Bufalino Configuracion Cbr</title>
<!-- Link to the Favicon -->
                      ...
                      if (empty($cbrsData)) {
                          ...
                          foreach ($cbrsData as $row) {
                              ...
                              echo '        <button class="btn btn-warning btn-sm edit-cbr" 
                                              ...
                                              data-vacuna="' . htmlspecialchars($row['bc_cbr_vacuna'] ?? '') . '" 
                                              data-dosis="' . htmlspecialchars($row['bc_cbr_dosis'] ?? '') . '" 
                                              data-costo="' . htmlspecialchars($row['bc_cbr_costo'] ?? '') . '" 
                                              data-vigencia="' . htmlspecialchars($row['bc_cbr_vigencia'] ?? '') . '"
                              ...
                              // Column 1: Vacuna
                              echo "<td>" . htmlspecialchars($row['bc_cbr_vacuna'] ?? '') . "</td>";
                              
                              // Column 2: Dosis
                              echo "<td>" . htmlspecialchars($row['bc_cbr_dosis'] ?? 'N/A') . "</td>";
                              
                              // Column 3: Costo
                              echo "<td>" . htmlspecialchars($row['bc_cbr_costo'] ?? 'N/A') . "</td>";
                              
                              // Column 4: Vigencia
                              echo "<td>" . htmlspecialchars($row['bc_cbr_vigencia'] ?? 'N/A') . "</td>";
