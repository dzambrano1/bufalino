...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO bc_brucelosis (bc_brucelosis_vacuna, bc_brucelosis_dosis, bc_brucelosis_costo, bc_brucelosis_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE bc_brucelosis 
                    SET bc_brucelosis_vacuna = :vacuna, 
                        bc_brucelosis_dosis = :dosis, 
                        bc_brucelosis_costo = :costo, 
                        bc_brucelosis_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM bc_brucelosis WHERE id = :id";
