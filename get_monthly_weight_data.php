...
try {
    // Query to get total monthly weight from bh_peso table
    // Assumes date column is bh_peso_fecha and weight column is bh_peso_animal	
    ...
    $sql = "
        ...
        FROM bh_peso 
        WHERE bh_peso_animal	 > 0 -- Optionally filter out zero or invalid weights
        GROUP BY month 
        ORDER BY month ASC;
    ";
