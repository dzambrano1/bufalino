...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO bc_carbunco (bc_carbunco_vacuna, bc_carbunco_dosis, bc_carbunco_costo, bc_carbunco_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE bc_carbunco 
                    SET bc_carbunco_vacuna = :vacuna, 
                        bc_carbunco_dosis = :dosis, 
                        bc_carbunco_costo = :costo, 
                        bc_carbunco_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM bc_carbunco WHERE id = :id";
