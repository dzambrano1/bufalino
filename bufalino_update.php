...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            $checkQuery = "SELECT COUNT(*) as count FROM bufalino WHERE tagid = ?";
            ...
            if ($row['count'] > 0) {
                ...
                // Create update query
                $sql = "UPDATE bufalino SET " . implode(", ", $update_fields) . " WHERE tagid = ?";
                ...
                echo json_encode([
                    ...
                    "redirect" => "bufalino_register_compras.php"
                ]);
            } else {
                ...
                $sql = "INSERT INTO bufalino (" . implode(", ", $fields) . ") VALUES (" . implode(", ", $placeholders) . ")";
        ...
        case 'delete':
            ...
            $sql = "UPDATE bufalino SET fecha_compra = NULL, peso_compra = NULL, precio_compra = NULL WHERE tagid = ?";
    ...
    error_log("Error in bufalino_update.php: " . $e->getMessage());
