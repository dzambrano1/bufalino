...
if (!empty($fetched_orders)) {
    ...
    $items_query = "SELECT od.*, v.image AS bufalino_image -- Use alias for bufalino image 
                    FROM order_details od 
                    LEFT JOIN bufalino v ON od.tagid = v.tagid 
    ...
    foreach ($fetched_orders as $order) {
        ...
        try {
            ...
            foreach ($items_result as $item) {
                 // Prefer order_details image if exists, otherwise use bufalino image
                $item['image'] = $item['image'] ?: ($item['bufalino_image'] ?: './images/default_animal.png');
                unset($item['bufalino_image']); // Clean up alias
                $order_details[] = $item;
            }
        ...
        <div class="col-12">
            <div class="nav-links-container d-flex justify-content-center">
                <div class="nav-link-item text-center mx-3">
                    ...
                    <div>
                        <a class="nav-link" href="bufalino_feria.php">PUBLICADOS</a>
                    </div>
                </div>
    ...
    <div class="orders-container">
        ...
        <?php else: ?>
            ...
            <div class="empty-orders">
                ...
                <a href="bufalino_feria.php" class="btn btn-outline-primary mt-3">
