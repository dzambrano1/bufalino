...
<title>bufalino Register Health</title>
<!-- Link to the Favicon -->
...
<div class="container" id="nav-buttons">
    <div class="container nav-icons-container" id="nav-buttons">
        ...
        <div class="icon-button-container">
            <button onclick="window.location.href='./bufalino_registros.php'" class="icon-button">
...
<div class="container text-center">
  ...
  <!-- DataTable for bh_aftosa records -->
  
  <div class="container table-section" style="display: block;">
      <div class="table-responsive">
          <table id="bh_aftosaTable" class="table table-striped table-bordered">
              <thead>
                  <tr>
              ...
              <tbody>
                  <?php
                  try {
                      // Query to get all bh_salt records with animal name
                      $aftosaQuery = "SELECT c.*, v.nombre as animal_nombre,
                                CAST((c.bh_aftosa_dosis * c.bh_aftosa_costo) AS DECIMAL(10,2)) as total_value
                                FROM bh_aftosa c 
                                LEFT JOIN bufalino v ON c.bh_aftosa_tagid = v.tagid 
                                ORDER BY c.bh_aftosa_fecha DESC";
                      ...
                      // If no data, display a message
                        if (empty($aftosasData)) {
                          ...
                          foreach ($aftosasData as $row) {
                              ...
                              echo "<td>" . htmlspecialchars($row['bh_aftosa_fecha'] ?? '') . "</td>";                        
                              echo "<td>" . htmlspecialchars($row['animal_nombre'] ?? 'N/A') . "</td>";
                              echo "<td>" . htmlspecialchars($row['bh_aftosa_tagid'] ?? '') . "</td>";
                              echo "<td>" . htmlspecialchars($row['bh_aftosa_producto'] ?? '') . "</td>";
                              echo "<td>" . htmlspecialchars($row['bh_aftosa_dosis'] ?? '') . "</td>";
                              echo "<td>" . htmlspecialchars($row['bh_aftosa_costo'] ?? '') . "</td>";                              
                              
                              // Calculate due date and determine status
                              try {
                                  $aftosaDate = new DateTime($row['bh_aftosa_fecha']);
                                  ...
                                  error_log("Date error: " . $e->getMessage() . " for date: " . $row['bh_aftosa_fecha']);
                              ...
                              echo '<td class="text-center">
                                  <div class="btn-group" role="group">
                                      <button class="btn btn-warning btn-sm edit-aftosa" 
                                          ...
                                          data-tagid="' . htmlspecialchars($row['bh_aftosa_tagid'] ?? '') . '"
                                          data-vacuna="' . htmlspecialchars($row['bh_aftosa_producto'] ?? '') . '"
...
<div class="container text-center">
  ...
  <!-- DataTable for bh_brucelosis records -->
  
  <div class="container table-section" style="display: block;">
      <div class="table-responsive">
          <table id="bh_brucelosisTable" class="table table-striped table-bordered">
              <thead>
                  <tr>
                      <th class="text-center">ID</th>
                      <th class="text-center">Fecha</th>
              ...
              <tbody>
                  <?php
                  try {
                      // Query to get all bh_brucelosis records with animal name
                      $brucelosisQuery = "SELECT b.*, v.nombre as animal_nombre,
                                CAST((b.bh_brucelosis_dosis * b.bh_brucelosis_costo) AS DECIMAL(10,2)) as total_value
                                FROM bh_brucelosis b 
                                LEFT JOIN bufalino v ON b.bh_brucelosis_tagid = v.tagid 
                                ORDER BY b.bh_brucelosis_fecha DESC";
                      ...
                      if (empty($brucelosisData)) {
                          ...
                          foreach ($brucelosisData as $row) {
                              echo "<tr>";
                              echo "<td>" . htmlspecialchars($row['id'] ?? '') . "</td>";                        
                              echo "<td>" . htmlspecialchars($row['bh_brucelosis_fecha'] ?? '') . "</td>";                        
                              echo "<td>" . htmlspecialchars($row['animal_nombre'] ?? 'N/A') . "</td>";
                              echo "<td>" . htmlspecialchars($row['bh_brucelosis_tagid'] ?? '') . "</td>";
                              echo "<td>" . htmlspecialchars($row['bh_brucelosis_producto'] ?? '') . "</td>";
                              echo "<td>" . htmlspecialchars($row['bh_brucelosis_dosis'] ?? '') . "</td>";
                              echo "<td>" . htmlspecialchars($row['bh_brucelosis_costo'] ?? '') . "</td>";
                              
                              // Calculate due date and determine status
                              try {
                                  $brucelosisDate = new DateTime($row['bh_brucelosis_fecha']);
                                  ...
                                  // Handle invalid date format
                                  error_log("Date error: " . $e->getMessage() . " for date: " . $row['bh_brucelosis_fecha']);
                                  echo '<td class="text-center"><span class="badge bg-warning">ERROR</span></td>';
                              }
                              ...
                              echo '<td class="text-center">
                                  <div class="btn-group" role="group">
                                      <button class="btn btn-warning btn-sm edit-brucelosis" 
                                          data-id="' . htmlspecialchars($row['id'] ?? '') . '"
                                          data-tagid="' . htmlspecialchars($row['bh_brucelosis_tagid'] ?? '') . '"
                                          data-vacuna="' . htmlspecialchars($row['bh_brucelosis_producto'] ?? '') . '"
...
<div class="container text-center">
  ...
  <!-- DataTable for bh_carbunco records -->
  
  <div class="container table-section" style="display: block;">
      <div class="table-responsive">
          <table id="bh_carbuncoTable" class="table table-striped table-bordered">
              <thead>
                  <tr>
                      <th class="text-center">ID</th>
                      <th class="text-center">Fecha</th>
              ...
              <tbody>
                  <?php
                  try {
                      // Query to get all bh_carbunco records with animal name
                      $carbuncoQuery = "SELECT c.*, v.nombre as animal_nombre,
                                CAST((c.bh_carbunco_dosis * c.bh_carbunco_costo) AS DECIMAL(10,2)) as total_value
                                FROM bh_carbunco c 
                                LEFT JOIN bufalino v ON c.bh_carbunco_tagid = v.tagid 
                                ORDER BY c.bh_carbunco_fecha DESC";
                      ...
                      if (empty($carbuncoData)) {
                          ...
                          foreach ($carbuncoData as $row) {
                              ...
                              // Calculate due date and determine status
                              try {
                                  $carbuncoDate = new DateTime($row['bh_carbunco_fecha']);
                                  ...
                                  // Handle invalid date format
                                  error_log("Date error: " . $e->getMessage() . " for date: " . $row['bh_carbunco_fecha']);
                                  echo '<td class="text-center"><span class="badge bg-warning">ERROR</span></td>';
                              }
                              ...
                              echo '<td class="text-center">
                                  <div class="btn-group" role="group">
                                      <button class="btn btn-warning btn-sm edit-carbunco" 
                                          data-id="' . htmlspecialchars($row['id'] ?? '') . '"
                                          data-tagid="' . htmlspecialchars($row['bh_carbunco_tagid'] ?? '') . '"
                                          data-vacuna="' . htmlspecialchars($row['bh_carbunco_producto'] ?? '') . '"
...
<div class="container text-center">
  ...
  <!-- DataTable for bh_ibr records -->
  
  <div class="container table-section" style="display: block;">
      <div class="table-responsive">
          <table id="bh_ibrTable" class="table table-striped table-bordered">
              <thead>
                  <tr>
                      <th class="text-center">ID</th>
                      <th class="text-center">Fecha</th>
              ...
              <tbody>
                  <?php
                  try {
                      // Query to get all bh_ibr records with animal name
                      $ibrQuery = "SELECT c.*, v.nombre as animal_nombre,
                                CAST((c.bh_ibr_dosis * c.bh_ibr_costo) AS DECIMAL(10,2)) as total_value
                                FROM bh_ibr c 
                                LEFT JOIN bufalino v ON c.bh_ibr_tagid = v.tagid 
                                ORDER BY c.bh_ibr_fecha DESC";
                      ...
                      if (empty($ibrsData)) {
                          ...
                          foreach ($ibrsData as $row) {
                              echo "<tr>";
                              echo "<td>" . htmlspecialchars($row['id'] ?? '') . "</td>";                        
                              echo "<td>" . htmlspecialchars($row['bh_ibr_fecha'] ?? '') . "</td>";                        
                              echo "<td>" . htmlspecialchars($row['animal_nombre'] ?? 'N/A') . "</td>";
                              echo "<td>" . htmlspecialchars($row['bh_ibr_tagid'] ?? '') . "</td>";
                              echo "<td>" . htmlspecialchars($row['bh_ibr_producto'] ?? '') . "</td>";
                              echo "<td>" . htmlspecialchars($row['bh_ibr_dosis'] ?? '') . "</td>";
                              echo "<td>" . htmlspecialchars($row['bh_ibr_costo'] ?? '') . "</td>";
                              
                              // Calculate due date and determine status
                              try {
                                  $ibrDate = new DateTime($row['bh_ibr_fecha']);
                                  ...
                                  // Handle invalid date format
                                  error_log("Date error: " . $e->getMessage() . " for date: " . $row['bh_ibr_fecha']);
                                  echo '<td class="text-center"><span class="badge bg-warning">ERROR</span></td>';
                              }
                              ...
                              echo '<td class="text-center">
                                  <div class="btn-group" role="group">
                                      <button class="btn btn-warning btn-sm edit-ibr" 
                                          data-id="' . htmlspecialchars($row['id'] ?? '') . '"
                                          data-tagid="' . htmlspecialchars($row['bh_ibr_tagid'] ?? '') . '"
                                          data-vacuna="' . htmlspecialchars($row['bh_ibr_vacuna'] ?? '') . '"
...
<div class="container text-center">
  ...
  <!-- DataTable for bh_cbr records -->
  
  <div class="container table-section" style="display: block;">
      <div class="table-responsive">
          <table id="bh_cbrTable" class="table table-striped table-bordered">
              <thead>
                  <tr>
                      <th class="text-center">ID</th>
                      <th class="text-center">Fecha</th>
              ...
              <tbody>
                  <?php
                  try {
                      // Query to get all bh_cbr records with animal name
                      $cbrQuery = "SELECT c.*, v.nombre as animal_nombre,
                                CAST((c.bh_cbr_dosis * c.bh_cbr_costo) AS DECIMAL(10,2)) as total_value
                                FROM bh_cbr c 
                                LEFT JOIN bufalino v ON c.bh_cbr_tagid = v.tagid 
                                ORDER BY c.bh_cbr_fecha DESC";
                      ...
                      if (empty($cbrsData)) {
                          ...
                          foreach ($cbrsData as $row) {
                              echo "<tr>";
                              echo "<td>" . htmlspecialchars($row['id'] ?? '') . "</td>";                        
                              echo "<td>" . htmlspecialchars($row['bh_cbr_fecha'] ?? '') . "</td>";                        
                              echo "<td>" . htmlspecialchars($row['animal_nombre'] ?? 'N/A') . "</td>";
                              echo "<td>" . htmlspecialchars($row['bh_cbr_tagid'] ?? '') . "</td>";
                              echo "<td>" . htmlspecialchars($row['bh_cbr_producto'] ?? '') . "</td>";
                              echo "<td>" . htmlspecialchars($row['bh_cbr_dosis'] ?? '') . "</td>";
                              echo "<td>" . htmlspecialchars($row['bh_cbr_costo'] ?? '') . "</td>";
                              
                              // Calculate due date and determine status
                              try {
                                  $cbrDate = new DateTime($row['bh_cbr_fecha']);
                                  ...
                                  // Handle invalid date format
                                  error_log("Date error: " . $e->getMessage() . " for date: " . $row['bh_cbr_fecha']);
                                  echo '<td class="text-center"><span class="badge bg-warning">ERROR</span></td>';
                              }
                              ...
                              echo '<td class="text-center">
                                  <div class="btn-group" role="group">
                                      <button class="btn btn-warning btn-sm edit-cbr" 
                                          data-id="' . htmlspecialchars($row['id'] ?? '') . '"
                                          data-tagid="' . htmlspecialchars($row['bh_cbr_tagid'] ?? '') . '"
                                          data-dosis="' . htmlspecialchars($row['bh_cbr_dosis'] ?? '') . '"
                                          data-vacuna="' . htmlspecialchars($row['bh_cbr_producto'] ?? '') . '"
...
<div class="container text-center">
  ...
  <!-- DataTable for bh_garrapatas records -->
  
  <div class="container table-section" style="display: block;">
      <div class="table-responsive">
          <table id="bh_garrapatasTable" class="table table-striped table-bordered">
              <thead>
                  <tr>
                      <th class="text-center">ID</th>
                      <th class="text-center">Fecha</th>
              ...
              <tbody>
                  <?php
                  try {
                      // Query to get all bh_garrapatas records with animal name
                      $garrapatasQuery = "SELECT c.*, v.nombre as animal_nombre,
                                CAST((c.bh_garrapatas_dosis * c.bh_garrapatas_costo) AS DECIMAL(10,2)) as total_value
                                FROM bh_garrapatas c 
                                LEFT JOIN bufalino v ON c.bh_garrapatas_tagid = v.tagid 
                                ORDER BY c.bh_garrapatas_fecha DESC";
                      ...
                      if (empty($garrapatasData)) {
                          ...
                          foreach ($garrapatasData as $row) {
                              ...
                              // Calculate due date and determine status
                              try {
                                  $garrapatasDate = new DateTime($row['bh_garrapatas_fecha']);
                                  ...
                                  // Handle invalid date format
                                  error_log("Date error: " . $e->getMessage() . " for date: " . $row['bh_garrapatas_fecha']);
                                  echo '<td class="text-center"><span class="badge bg-warning">ERROR</span></td>';
                              }
                              ...
                              echo '<td class="text-center">
                                  <div class="btn-group" role="group">
                                      <button class="btn btn-warning btn-sm edit-garrapatas" 
                                          data-id="' . htmlspecialchars($row['id'] ?? '') . '"
                                          data-tagid="' . htmlspecialchars($row['bh_garrapatas_tagid'] ?? '') . '"
                                          data-vacuna="' . htmlspecialchars($row['bh_garrapatas_producto'] ?? '') . '"
...
<div class="container text-center">
  ...
  <!-- DataTable for bh_lombrices records -->
  
  <div class="container table-section" style="display: block;">
      <div class="table-responsive">
          <table id="bh_lombricesTable" class="table table-striped table-bordered">
              <thead>
                  <tr>
                      <th class="text-center">ID</th>
                      <th class="text-center">Fecha</th>
              ...
              <tbody>
                  <?php
                  try {
                      // Query to get all bh_lombrices records with animal name
                      $lombricesQuery = "SELECT c.*, v.nombre as animal_nombre,
                                CAST((c.bh_lombrices_dosis * c.bh_lombrices_costo) AS DECIMAL(10,2)) as total_value
                                FROM bh_lombrices c 
                                LEFT JOIN bufalino v ON c.bh_lombrices_tagid = v.tagid 
                                ORDER BY c.bh_lombrices_fecha DESC";
                      ...
                      if (empty($lombricesData)) {
                          ...
                          foreach ($lombricesData as $row) {
                              ...
                              // Calculate due date and determine status
                              try {
                                  $lombricesDate = new DateTime($row['bh_lombrices_fecha']);
                                  ...
                                  // Handle invalid date format
                                  error_log("Date error: " . $e->getMessage() . " for date: " . $row['bh_lombrices_fecha']);
                                  echo '<td class="text-center"><span class="badge bg-warning">ERROR</span></td>';
                              }
                              ...
                              echo '<td class="text-center">
                                  <div class="btn-group" role="group">
                                      <button class="btn btn-warning btn-sm edit-lombrices" 
                                          data-id="' . htmlspecialchars($row['id'] ?? '') . '"
                                          data-tagid="' . htmlspecialchars($row['bh_lombrices_tagid'] ?? '') . '"
                                          data-vacuna="' . htmlspecialchars($row['bh_lombrices_producto'] ?? '') . '"
...
<div class="container text-center">
  ...
  <!-- DataTable for bh_mastitis records -->
  
  <div class="container table-section" style="display: block;">
      <div class="table-responsive">
          <table id="bh_mastitisTable" class="table table-striped table-bordered">
              <thead>
                  <tr>
                      <th class="text-center">ID</th>
                      <th class="text-center">Fecha</th>
              ...
              <tbody>
                  <?php
                  try {
                      // Query to get all bh_mastitis records with animal name
                      $mastitisQuery = "SELECT c.*, v.nombre as animal_nombre,
                                CAST((c.bh_mastitis_dosis * c.bh_mastitis_costo) AS DECIMAL(10,2)) as total_value
                                FROM bh_mastitis c 
                                LEFT JOIN bufalino v ON c.bh_mastitis_tagid = v.tagid 
                                ORDER BY c.bh_mastitis_fecha DESC";
                      ...
                      if (empty($mastitisData)) {
                          ...
                          foreach ($mastitisData as $row) {
                              ...
                              // Calculate due date and determine status
                              try {
                                  $mastitisDate = new DateTime($row['bh_mastitis_fecha']);
                                  ...
                                  // Handle invalid date format
                                  error_log("Date error: " . $e->getMessage() . " for date: " . $row['bh_mastitis_fecha']);
                                  echo '<td class="text-center"><span class="badge bg-warning">ERROR</span></td>';
                              }
                              ...
                              echo '<td class="text-center">
                                  <div class="btn-group" role="group">
                                      <button class="btn btn-warning btn-sm edit-mastitis" 
                                          data-id="' . htmlspecialchars($row['id'] ?? '') . '"
                                          data-tagid="' . htmlspecialchars($row['bh_mastitis_tagid'] ?? '') . '"
                                          data-vacuna="' . htmlspecialchars($row['bh_mastitis_producto'] ?? '') . '"
