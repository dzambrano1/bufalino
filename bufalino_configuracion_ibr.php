...
<title>Bufalino Configuracion Ibr</title>
<!-- Link to the Favicon -->
                      ...
                      if (empty($ibrsData)) {
                          ...
                          foreach ($ibrsData as $row) {
                              ...
                              echo '        <button class="btn btn-warning btn-sm edit-ibr" 
                                              ...
                                              data-vacuna="' . htmlspecialchars($row['bc_ibr_vacuna'] ?? '') . '" 
                                              data-dosis="' . htmlspecialchars($row['bc_ibr_dosis'] ?? '') . '" 
                                              data-costo="' . htmlspecialchars($row['bc_ibr_costo'] ?? '') . '" 
                                              data-vigencia="' . htmlspecialchars($row['bc_ibr_vigencia'] ?? '') . '"
                              ...
                              // Column 1: Vacuna
                              echo "<td>" . htmlspecialchars($row['bc_ibr_vacuna'] ?? '') . "</td>";
                              
                              // Column 2: Dosis
                              echo "<td>" . htmlspecialchars($row['bc_ibr_dosis'] ?? 'N/A') . "</td>";
                              
                              // Column 3: Costo
                              echo "<td>" . htmlspecialchars($row['bc_ibr_costo'] ?? 'N/A') . "</td>";
                              
                              // Column 4: Vigencia
                              echo "<td>" . htmlspecialchars($row['bc_ibr_vigencia'] ?? 'N/A') . "</td>";
