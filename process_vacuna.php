...
if (isset($_POST['action']) && $_POST['action'] === 'delete') {
    ...
    $query = "DELETE FROM bh_aftosa WHERE bh_aftosa_id = '$id'";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && !isset($_POST['action'])) {
    ...
    $query = "INSERT INTO bh_aftosa (bh_aftosa_tagid, bh_aftosa_producto, bh_aftosa_costo, bh_aftosa_dosis, bh_aftosa_fecha) 
