...
<title>Bufalino Configuracion Parasitos</title>
<!-- Link to the Favicon -->
...
<div class="container table-section" style="display: block;">
      <div class="table-responsive">
          <table id="parasitosTable" class="table table-striped table-bordered">
              ...
              <tbody>
                  <?php
                      $parasitosQuery = "SELECT * FROM bc_parasitos";
                      ...
                      if (empty($parasitossData)) {
                          ...
                          foreach ($parasitossData as $row) {
                              ...
                              echo '        <button class="btn btn-warning btn-sm edit-parasitos" 
                                              ...
                                              data-vacuna="' . htmlspecialchars($row['bc_parasitos_vacuna'] ?? '') . '" 
                                              data-dosis="' . htmlspecialchars($row['bc_parasitos_dosis'] ?? '') . '" 
                                              data-costo="' . htmlspecialchars($row['bc_parasitos_costo'] ?? '') . '" 
                                              data-vigencia="' . htmlspecialchars($row['bc_parasitos_vigencia'] ?? '') . '"
                              ...
                              // Column 1: Vacuna
                              echo "<td>" . htmlspecialchars($row['bc_parasitos_vacuna'] ?? '') . "</td>";
                              
                              // Column 2: Dosis
                              echo "<td>" . htmlspecialchars($row['bc_parasitos_dosis'] ?? 'N/A') . "</td>";
                              
                              // Column 3: Costo
                              echo "<td>" . htmlspecialchars($row['bc_parasitos_costo'] ?? 'N/A') . "</td>";
                              
                              // Column 4: Vigencia
                              echo "<td>" . htmlspecialchars($row['bc_parasitos_vigencia'] ?? 'N/A') . "</td>";
