...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO bc_aftosa (bc_aftosa_vacuna, bc_aftosa_dosis, bc_aftosa_costo, bc_aftosa_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE bc_aftosa 
                    SET bc_aftosa_vacuna = :vacuna, 
                        bc_aftosa_dosis = :dosis, 
                        bc_aftosa_costo = :costo, 
                        bc_aftosa_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM bc_aftosa WHERE id = :id";
