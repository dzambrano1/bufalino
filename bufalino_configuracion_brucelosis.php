...
<title>bufalino Configuracion Brucelosis</title>
<!-- Link to the Favicon -->
...
<div class="container table-section" style="display: block;">
      <div class="table-responsive">
          <table id="brucelosisTable" class="table table-striped table-bordered">
              ...
              <tbody>
                  <?php
                      $brucelosisQuery = "SELECT * FROM bc_brucelosis";
                      ...
                      if (empty($brucelosissData)) {
                          ...
                          foreach ($brucelosissData as $row) {
                              ...
                              echo '        <button class="btn btn-warning btn-sm edit-brucelosis" 
                                              ...
                                              data-vacuna="' . htmlspecialchars($row['bc_brucelosis_vacuna'] ?? '') . '" 
                                              data-dosis="' . htmlspecialchars($row['bc_brucelosis_dosis'] ?? '') . '" 
                                              data-costo="' . htmlspecialchars($row['bc_brucelosis_costo'] ?? '') . '" 
                                              data-vigencia="' . htmlspecialchars($row['bc_brucelosis_vigencia'] ?? '') . '"
                              ...
                              // Column 1: Vacuna
                              echo "<td>" . htmlspecialchars($row['bc_brucelosis_vacuna'] ?? '') . "</td>";
                              
                              // Column 2: Dosis
                              echo "<td>" . htmlspecialchars($row['bc_brucelosis_dosis'] ?? 'N/A') . "</td>";
                              
                              // Column 3: Costo
                              echo "<td>" . htmlspecialchars($row['bc_brucelosis_costo'] ?? 'N/A') . "</td>";
                              
                              // Column 4: Vigencia
                              echo "<td>" . htmlspecialchars($row['bc_brucelosis_vigencia'] ?? 'N/A') . "</td>";
